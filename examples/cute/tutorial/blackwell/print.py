...
cp cutlass2/examples/cute/tutorial/blackwell/01_mma_sm100.cu profile_data/
cp cutlass2/examples/cute/tutorial/blackwell/example_utils.hpp profile_data/
cd profile_data 
nvcc 01_mma_sm100.cu 2>&1 >> build.log 
./a.out 2>&1 >> run.log 
rm -rf a.out *.cu *.hpp
""")
